...
export const IMEI_NUMBER = /^\d{15}(,\d{15})*$/;
...
export const MAX_CHAR_TO_SEARCH = 3;
export const MAX_DELAY_TO_SEARCH = 2000;
export const PATTERN_FOR_ALPHABATES_DIGIT_SPACE_AND_MIN_1_CHAR =
  /^(?=.*[a-zA-Z0-9])[a-zA-Z0-9\s]+$/i;
export const PATTER_FOR_NUMBER_COMMA_AND_DOT = /^[0-9,.]+$/;
